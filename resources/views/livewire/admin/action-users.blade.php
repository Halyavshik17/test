<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    ...
    <x-jet-dialog-modal wire:model="showingModalCreate" maxWidth="md">
        ...
        <x-slot name="content">
            ...
            <div class="col-span-6 sm:col-span-4 mt-4">
                <label for="roles" class="block text-sm font-medium text-gray-700">Роль</label>
                <select id="roles" name="roles" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    <option>Админ</option>
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <div class="mr-2">
                                        <img class="w-6 h-6 rounded-full object-cover" src="{{ $user->profile_photo_url }}"/>
                                    </div>
                                    <span>{{ $user->name }}</span>
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <button type="submit" wire:click="showModalEdit({{ $user->id }})" wire:loading.attr="disabled" class="w-4 mr-2 transform hover:text-gray-600 hover:scale-110">
